...
public class Problem2 {
    ...
    public static void main(String[] args) {
        Scanner input = new Scanner(Problem2.class.getResourceAsStream("day12.json"));
    ...
    private static int sumOfNumbers(JsonElement object) {
        int sum = 0;
        ...
        for (JsonElement element : elements) {
            if (element.isJsonArray()) {
                ...
                try {
                    ...
                    //System.out.println("Could not parse " + element + " as number");
                }
            }
        }
        return sum;
